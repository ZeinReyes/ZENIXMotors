...
<head>
  ...
  <link rel="stylesheet" href="{{ url('admin/plugins/sweetalert2/sweetalert2.css') }}">
...
<script src="{{ url('admin/plugins/sweetalert2/sweetalert2.all.js') }}"></script>
